...
class CancleeClinic extends StatefulWidget {
  @override
  _CancleeClinicRestState createState() => _CancleeClinicRestState();
}

class _CancleeClinicRestState extends State<CancleeClinic> {
  @override
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ConfiramationClinic()));
                        },
                      ),
                    ),
                    SizedBox(
