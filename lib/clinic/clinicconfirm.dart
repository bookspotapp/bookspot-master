...
import 'package:bookspot/clinic/serviceclinic.dart';
...
class ConfiramationClinic extends StatefulWidget {
  @override
  _ConfiramationClinicState createState() => _ConfiramationClinicState();
}

class _ConfiramationClinicState extends State<ConfiramationClinic> {
  @override
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => ServicesClinic()));
                          },
                        ),
                      ),
                      SizedBox(
