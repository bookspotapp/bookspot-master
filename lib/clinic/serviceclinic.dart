...
class ServicesClinic extends StatefulWidget {
  @override
  _ServicesClinicState createState() => _ServicesClinicState();
}

class _ServicesClinicState extends State<ServicesClinic> {
  int _value = 1;
  int _itemCount = 0;
  @override
